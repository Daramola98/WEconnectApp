...
const userHomeNumberErrorMessage = 'Telephone Number should be 11 characters';
const userPassword = 'password should be more than 5 and not greater than 16 characters';
