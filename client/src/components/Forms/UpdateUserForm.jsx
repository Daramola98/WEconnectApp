          ...
          <form onSubmit={this.handleUpdateSubmit.bind(this)}>
            ...
            <div className="row">
              <div className="input-field col s12 m12 l12">
                ...
                <input type="email" value={email} onChange={this.onChange} pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" name="email" className="validate" />
              </div>
            </div>
            <div className="row">
              <div className="input-field col s12 m12 l6">
