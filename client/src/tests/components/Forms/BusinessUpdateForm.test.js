...
import BusinessUpdateForm from '../../../components/Forms/BusinessUpdateForm.jsx';

describe('<BusinessUpdateForm />', () => {
  let wrapper;

  beforeEach(() => {
    wrapper = shallow(<BusinessUpdateForm
         submit={() => wrapper.setState({ submitted: true })}
         categories={['Technology', 'Gaming']} />);
  });

  describe('Business Name input', () => {
    it('should respond to change event and change the state of the BusinessUpdateForm Component', () => {
      wrapper.setState({
        business: {
          name: '',
          location: 'null',
  ...
  describe('BusinessUpdateForm Form Submit', () => {
    it('should respond to submit event and change the state of the BusinessUpdateForm Component', () => {
